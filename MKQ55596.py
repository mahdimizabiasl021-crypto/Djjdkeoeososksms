...
reply_state = {}       # owner_id -> (target_user_id, reply_to_message_id)
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if context.args:
        ...
        await update.message.reply_text("پیامت رو بنویس، مستقیم ارسال میشه ✉️")
        return
...
async def buttons(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "get_link":
        ...
        reply_state[user_id] = (target_id, query.message.reply_to_message.message_id)
        await query.message.reply_text("پیامت رو بنویس:")

    elif query.data == "send_again":
        await query.message.reply_text("پیامت رو بنویس:")
...
async def text_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # second user sending via link (FORWARD)
